    ...
    protected ArrayList<Tag> getArrayListFromJSONString(String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Tag thing = new Tag(jsonObject.getString("CDS"),
                                    jsonObject.getString("waterpump"),
...
//        String motor;
        ...
        public Tag(String chodo, String waterp, String waterl, String time) {
            CDS = chodo;
            waterpump = waterp;
            waterlevel = waterl;
//            motor = motorr;
        ...
        public String toString() {
            return String.format("[%s] CDS: %s, waterpump: %s, waterlevel: %s", timestamp, CDS, waterpump, waterlevel);
        }
    }
}
